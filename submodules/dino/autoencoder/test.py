...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(data_imgs))):
        ...
        # PCA
            outputs_1d = outputs.reshape(16,-1).permute(1,0)
            ...
            projection_norm = (projection + 70) / (160)
            ...
            torchvision.utils.save_image(projection_norm, 'colmap_pca/{}.jpg'.format(data_imgs[i][:-3]))
